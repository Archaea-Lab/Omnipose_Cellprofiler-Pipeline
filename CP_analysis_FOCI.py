...
def calculateShape(df,pixelConversion):
    ...
    df['Circularity']= df['AreaShape_FormFactor']
...
def main():
    ...
    trackImageDirectory = '/Users/johnmallon/Downloads/CP test for foci/'
    trackImageFileName = 'data_30Frames_CPidentificationOverlay.tiff'
    outputDirectory = '/Users/johnmallon/Downloads/CP test for foci/'
